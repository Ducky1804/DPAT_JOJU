...
//     {
//         IRenderer<SimpleState> renderer = _renderFactory.CreateStateRenderer(state, state.GetType());
...
//     {
//         IRenderer<InitialState> renderer = _renderFactory.CreateStateRenderer(state, state.GetType());
//         String renderedComponent = renderer.Render(state);
//         new ConsolePrinter().Print(renderedComponent);
//     }
//
...
//     {
//         IRenderer<FinalState> renderer = _renderFactory.CreateStateRenderer(state, state.GetType());
//         string renderedComponent = renderer.Render(state);
//         new ConsolePrinter().Print(renderedComponent);
//     }
//
...
//     {
//         IRenderer<CompoundState> renderer = _renderFactory.CreateStateRenderer(state, state.GetType());
//         string renderedComponent = renderer.Render(state);
//         new ConsolePrinter().Print(renderedComponent);
//     }
//
